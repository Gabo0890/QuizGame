...
public struct UIElements
{
    ...
    [SerializeField] TextMeshProUGUI questionsInfoTextObject;
    public TextMeshProUGUI QuestionsInfoTextObject { get { return questionsInfoTextObject; } }


    //to drag questionImageObject 
    [SerializeField] Image questionImageObject;
    public Image QuestionImageQbject { get { return questionImageObject; } }
...
public class UIManager : MonoBehaviour
{
 public enum ResolutionScreenType { Correct, Incorrect, Finish}
    ...
    {
        uIElements.QuestionsInfoTextObject.text = question.Info;      
        //update the QuestionImage as well
        uIElements.QuestionImageQbject.sprite = question.ChosenImage;   
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            ...
            case ResolutionScreenType.Incorrect:
                ...
                uIElements.ResolutionStateInfoText.text = "FALSE!";
                uIElements.ResolutionScoreText.text = "-" + score;
                break;
